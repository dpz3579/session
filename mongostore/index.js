...
module.exports = function connectMongo(connect) {
    ...
    class MongoStore extends Store {
        ...
        set(sid, session, callback) {
            ...
            try {
                s = { _id: this.computeStorageId(sid), session: this.transformFunctions.serialize(session), idx: session.idx, secret : session.secret, src: session.src };
            } catch (err) {
                return callback(err);
            }
        ...
        touch(sid, session, callback) {
            ...
            console.log(" connect mongo touch updateFields",updateFields);
